...
import 'package:flutter_start/presentation/pattern/repository/user_repository.dart';
...
import 'mvvm/pattern2_page.dart';
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.of(context).push<bool>(
                  CupertinoPageRoute(builder: (_) => MvvmPage(viewModel: viewModel)),
                );
              },
              style: ElevatedButton.styleFrom(
                padding: const EdgeInsets.symmetric(
              ...
              child: const Text('MVVM Pattern', style: TextStyle(fontSize: 16)),
            ),
          ],
        ),
      ),
